...
--
-- Table structure for table `weekly_stock_data`
--

DROP TABLE IF EXISTS `weekly_stock_data`;
...
--
-- Dumping data for table `weekly_stock_data`
--

LOCK TABLES `weekly_stock_data` WRITE;
/*!40000 ALTER TABLE `weekly_stock_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `weekly_stock_data` ENABLE KEYS */;
UNLOCK TABLES;
